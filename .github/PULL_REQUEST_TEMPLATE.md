...
`I hereby agree to Spryker's Contribution License Agreement in https://github.com/spryker-shop/cms-content-widget-product-set-connector/blob/HASH_OF_COMMIT_YOU_ARE_BASING_YOUR_BRANCH_FROM_MASTER_BRANCH/CONTRIBUTING.md.`
